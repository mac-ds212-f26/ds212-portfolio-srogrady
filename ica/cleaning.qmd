...
weather_data <- readr::read_csv('/Users/shayleeogrady/Documents/macalester/fall 2026/data sci/portfolio/ica/data/raw/weather.csv')
```
...
```{r}
write_csv(weather_data_2, file = "data/processed/weather_data_2.csv")
```
